...
namespace Digital_Attendance
{
    public partial class Attendance : Form
    {
        ...
        public Attendance()
        {
            ...
            {
                comboBoxCourses.Items.Add(DRCourses[0]);
            }
            DRCourses.Close();
        }
        ...
        {
            dataGridViewAttn.Rows.Clear();
            foreach (DataRow item in dt.Rows)
            {
                int n = dataGridViewAttn.Rows.Add();
                dataGridViewAttn.Rows[n].Cells[0].Value = item["student_id"].ToString();
                dataGridViewAttn.Rows[n].Cells[1].Value = item["course_code"].ToString();
                dataGridViewAttn.Rows[n].Cells[2].Value = item["attendence_date"].ToString();
                dataGridViewAttn.Rows[n].Cells[3].Value = item["is_present"].ToString();
            }
        }
        ...
        private void comboBoxCourses_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (comboCourseValue != "")
            {
                DataTable Dtable = oper.ViewAttanByCourses(comboCourseValue);
        ...
        private void printDocument1_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                iTotalWidth = 0;
                foreach (DataGridViewColumn dgvGridCol in dataGridViewAttn.Columns)
                {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                if (bFirstPage)
                {
                    foreach (DataGridViewColumn GridCol in dataGridViewAttn.Columns)
                    {
                ...
                while (iRow <= dataGridViewAttn.Rows.Count - 1)
                {
                    DataGridViewRow GridRow = dataGridViewAttn.Rows[iRow];
                    //Set the cell height
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            //Draw Date
                            e.Graphics.DrawString(strDate, new Font(dataGridViewAttn.Font, FontStyle.Bold),
